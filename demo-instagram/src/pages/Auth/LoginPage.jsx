            ...
            <div className="auth-container">
                ...
                <div className="auth-card">
                    ...
                    <form className="auth-form" onSubmit={handleLogin}>
                        <AOMInput id="auth.login.username" description="Phone number, username, or email" inputType="text" group="auth">
                            <Input
                                type="email"
                        ...
                        <AOMInput id="auth.login.password" description="Password" inputType="password" group="auth">
                            <Input
                                type="password"
                        ...
                        <AOMAction id="auth.login.submit" description="Log in to Instagram" safety={0.9} group="auth">
                    ...
                    <AOMAction id="auth.login.google" description="Continue with Google" safety={0.9} group="auth">
                    ...
                    <AOMLink id="auth.login.forgot_password" description="Forgot password" destination="Forgot password page" group="auth">
                ...
                <div className="auth-switch-card">
                    ...
                    <AOMLink id="auth.login.signup" description="Go to sign up page" destination="Sign up page" group="auth">
