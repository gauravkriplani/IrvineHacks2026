 ...
 */
export default function TiltCard({ children, className = '', style = {}, maxTilt = 14, glare = true }) {
  const cardRef  = useRef(null);
  const glareRef = useRef(null);

  // Spring state — all mutable, no re-renders needed
  ...
  useEffect(() => {
    ...
    const STIFFNESS = 0.5;   // lerp factor — lower = more springy
    const THRESHOLD = 0.05;  // stop animating when close enough
    ...
    function tick() {
      ...
      if (gl) {
        // Glare follows the high-point of the tilt
    ...
    function onMouseMove(e) {
      ...
      // Normalized -1 … +1 from centre of card
