      ...
      <div style={styles.card}>
        ...
        >
          ...
          {status === 'loading' ? (
            ...
            <>
              ...
              <span style={styles.dropText}>Drag &amp; drop your <b>source.zip</b> here, or <u>click to browse</u></span>
            </>
          )}
        </label>
        ...
        <div style={styles.info}>
          ...
          <ol style={{ marginTop: 6, paddingLeft: 18, lineHeight: 1.7 }}>
            ...
            <li>Download <code>aom-wrappers.zip</code> containing per-file wrapper metadata and a <code>manifest.json</code>.</li>
            <li>Drop the <code>AI/</code> folder into your project and use the metadata to accelerate agent workflows.</li>
          </ol>
        </div>
      </div>
    </div>
