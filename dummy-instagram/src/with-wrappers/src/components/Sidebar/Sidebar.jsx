...
import { AOMAction, AOMLink } from '../../../../../../aom-wrappers';
...
const navItems = [
    ...
    { id: 'explore', to: '/explore', label: 'Explore', Icon: ExploreIcon },
    { id: 'reels', to: '/reels', label: 'Reels', Icon: ReelsIcon },
    { id: 'messages', to: '/messages', label: 'Messages', Icon: MessageIcon },
    { id: 'notifications', to: '/notifications', label: 'Notifications', Icon: HeartIcon },
];
...
export default function Sidebar() {
    ...
    return (
        <nav className={`sidebar ${collapsed ? 'sidebar--collapsed' : ''}`}>
            {/* Logo */}
            <AOMLink id="nav.logo_home" description="Navigate to Home via Logo" destination="Home" group="nav">
            ...
            <ul className="sidebar__nav">
                {navItems.map(({ id, to, label, Icon }) => (
                    <li key={to}>
                        <AOMLink id={`nav.${id}`} description={`Navigate to ${label}`} destination={label} group="nav">
                ...
                <li>
                    <AOMAction id="nav.create_post" description="Open create post modal" safety={0.9} group="nav">
                        <button className="sidebar__link sidebar__create" onClick={() => { }}>
                            <span className="sidebar__icon"><CreateIcon /></span>
                            {!collapsed && <span className="sidebar__label">Create</span>}
                        </button>
                    </AOMAction>
                </li>
                <li>
                    <AOMLink id="nav.profile" description="Navigate to your profile" destination="Profile" group="nav">
            ...
            <div className="sidebar__bottom">
                <AOMAction id="nav.toggle_menu" description="Toggle sidebar more menu" safety={1} group="nav">
